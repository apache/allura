...
class TestFunctionalController(TrackerTestController):
    ...
    def test_delete_attachment(self):
        ...
        file_link = BeautifulSoup(form.text, features="html.parser").find_all('a')[2]
    ...
    def test_new_text_attachment_content(self):
        ...
        download = self.app.get(str(BeautifulSoup(form.text, features="html.parser").find_all('a')[2]['href']))
    ...
    def test_new_ticket_validation(self):
        ...
        error_message = BeautifulSoup(form.text, features="html.parser").find('div', {'class': 'error'})
