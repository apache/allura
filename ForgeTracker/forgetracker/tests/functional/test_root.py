...
class TestFunctionalController(TrackerTestController):
    ...
    def test_bulk_edit_index(self):
        ...
        ticket_rows = response.html.find('table', {'class':'ticket-list'}).find('tbody').findAll('tr')
        assert_in('test first ticket', str(ticket_rows[0].findAll('td')[1]))
        assert_in('test second ticket', str(ticket_rows[1].findAll('td')[1]))
        ...
        ticket_rows = response.html.find('tbody', {'class':'ticket-list'}).findAll('tr')
        assert_in('test first ticket', str(ticket_rows[1].findAll('td')[2]))
        assert_in('test second ticket', str(ticket_rows[0].findAll('td')[2]))
