...
class TestSubscriber(TestController):
    ...
    def test_add_subscriber(self):
        ...
        self.app.post("/nf/admin/add_subscribers",params=dict(for_user="root",artifact_url="http://localhost:8080/u/test-admin/wiki/Home/"))



        assert 1 == Mailbox.query.find(dict(user_id=M.User.by_username("root")._id,artifact_url="/u/test-admin/wiki/Home/")).count()
