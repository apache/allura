...
class TestHTMLSanitizer:
    ...
    def test_html_sanitizer_dangerous_urls(self):
        assert self.sanitize_html('<a href="javascript:alert(1)">x</a>') == '<a>x</a>'
        assert self.sanitize_html('<a href="jAva\tscript:alert(1)">x</a>') == '<a>x</a>'
        assert (self.sanitize_html('<img src="data:image/png;base64,AAAA">') ==
                '<img src="data:image/png;base64,AAAA">')
        assert self.sanitize_html('<a href="data:text/html,<script>x</script>">y</a>') == '<a>y</a>'
