...
class TestProjectHome(TestController):
    ...
    def test_project_group_nav(self):
        ...
        assert {'url': '/p/test/wiki/', 'name': 'Wiki', 'icon':
                'tool-wiki', 'tool_name': 'wiki'} in wikis, wikis
        assert {'url': '/p/test/wiki2/', 'name': 'wiki2', 'icon':
                'tool-wiki', 'tool_name': 'wiki'} in wikis, wikis
    ...
    def test_project_group_nav_more_than_ten(self):
        ...
        assert {'url': '/p/test/_list/wiki', 'name': 'More...',
                'icon': 'tool-wiki', 'tool_name': 'wiki'} in wiki_menu['children']
