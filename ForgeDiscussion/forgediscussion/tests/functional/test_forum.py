...
from alluratest.controller import TestController, get_config_file
...
class TestForum(TestController):
    ...
    def test_sidebar_menu(self):
        ...
        assert '<a href="#" class="sidebar_thread_reply"><b data-icon="w" class="ico ico-reply"></b> <span>Reply to This</span></a>' not in sidebarmenu
        assert '<a href="#" class="sidebar_thread_tag"><b data-icon="z" class="ico ico-tag"></b> <span>Label This</span></a>' not in sidebarmenu
        assert '<a href="feed.rss"><b data-icon="f" class="ico ico-feed"></b> <span>Follow This</span></a>' not in sidebarmenu
        ...
        assert '<a href="#" class="sidebar_thread_reply"><b data-icon="w" class="ico ico-reply"></b> <span>Reply to This</span></a>' in thread_sidebarmenu
        assert '<a href="#" class="sidebar_thread_tag"><b data-icon="z" class="ico ico-tag"></b> <span>Label This</span></a>' in thread_sidebarmenu
        assert '<a href="feed.rss"><b data-icon="f" class="ico ico-feed"></b> <span>Follow This</span></a>' in thread_sidebarmenu
